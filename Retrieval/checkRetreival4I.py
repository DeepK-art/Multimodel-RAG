...
def get_summary_from_table(table_html):
    ...
    Summarize the information in this HTML table:
    {element}
    """)
...
if uploaded_file is not None:
    ...
    for table in tables:
        summary = get_summary_from_table(table.metadata.text_as_html)
...
if user_query:
    retrieved_chunks = search_faiss(user_query, top_k=4)
